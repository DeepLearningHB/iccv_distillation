...
# nohup python experiment_4_2.py --model_t wrn_40_4 --path_t ./save/models/wrn_40_4_best.pth --model_s wrn_16_4 --cuda_visible_devices 0 --max_dim 800 > exp4_2_1_wrn40_16_4.out &
# nohup python experiment_4_2.py --model_t resnet110 --path_t ./save/models/resnet110_best.pth --model_s resnet20 --cuda_visible_devices 0 --max_dim 230 > exp4_2_2_res110_20.out &
# nohup python experiment_4_2.py --model_t wrn_16_10 --path_t ./save/models/wrn_16_10_best.pth --model_s wrn_10_10 --cuda_visible_devices 1 --max_dim 964 > exp4_2_2_wrn16_10_10.out &
# nohup python experiment_4_2.py --model_t wrn_40_4 --path_t ./save/models/wrn_40_4_best.pth --model_s wrn_16_4 --cuda_visible_devices 0 --max_dim 800 > exp4_2_2_wrn40_16_4.out &
