...
parser.add_argument('--model_t', type=str, default='resnet8', choices=['resnet8', 'resnet14', 'resnet20', 'resnet32', 'resnet44', 'resnet56', 'resnet110',
                                 ...
                                 'MobileNetV2', 'ShuffleV1', 'ShuffleV2', 'wrn_40_4', 'wrn_40_6'])
...
#     conv_distiller.train()
    ...
    for idx, data in enumerate(train_loader):
        ...
        # FitNet + SD part
        for idx_, (conv, fs, ft) in enumerate(zip(trainable_models.conv_distiller, feat_s, feat_t)):
#             conv_logit_t, conv_feature_t = conv(ft.detach())
            ...
            loss_2 += 1e-1 * criterion_MSE(conv_feature_s, prev_activation)
