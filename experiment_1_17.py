...
class BNLoss():
    ...
    def hook_fn(self, module, input, output):
        ...
        T_mean = module.running_mean
        T_var = module.running_var
...
# bn_dict = {
#     'resnet110':['layer3.17.bn1', 'layer3.17.bn2'],
#     'resnet32':['layer3.4.bn1', 'layer3.4.bn2'],
#     'resnet20':['layer3.2.bn1', 'layer3.2.bn2'],
#     'resnet32x4':['layer3.4.bn1', 'layer3.4.bn2'],
#     'resnet8x4':['layer3.0.bn1', 'layer3.0.bn2'],
#     'vgg19':['block4.10'],
#     'vgg11':['block4.4'],
#     'wrn_40_1': ['bn1'],
#     'wrn_16_1': ['bn1']
...
module_list, bn_loss_list = [], []
for f in out_feat[:-1]:
    conv = TempDistiller(f.size(1), f.size(2), final_dim=final_dim).cuda()
    for module in conv.modules():
        if isinstance(module, nn.BatchNorm2d):
            bn_loss_list.append(BNLoss(module))
    module_list.append(conv)

conv_distiller = nn.ModuleList(module_list)
