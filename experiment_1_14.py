...
bn_dict = {
    'resnet110':['bn1', 'layer1.17.bn2', 'layer2.17.bn2', 'layer3.17.bn2'],
    'resnet32':['bn1', 'layer1.4.bn2', 'layer2.4.bn2', 'layer3.4.bn2'],
    'resnet20':['bn1', 'layer1.2.bn2', 'layer2.2.bn2', 'layer3.2.bn2'],
    'resnet32x4':['bn1', 'layer1.4.bn2', 'layer2.4.bn2', 'layer3.4.bn2'],
    'resnet8x4':['bn1', 'layer1.0.bn2', 'layer2.0.bn2', 'layer3.0.bn2'],
    'vgg19':['block0.4', 'block1.4', 'block2.10', 'block3.10', 'block4.10'],
    'vgg11':['block0.1', 'block1.1', 'block2.4', 'block3.4', 'block4.4'],
    'wrn_40_1': ['block1.layer.5.bn2', 'block2.layer.5.bn2', 'block3.layer.5.bn2', 'bn1'],
    'wrn_16_1': ['block1.layer.1.bn2', 'block2.layer.1.bn2', 'block3.layer.3.bn2', 'bn1']
}
...
#         loss_2 += fit_alpha * (kd_loss(logit_s, last_before_logit.detach()) * (kd_T**2))
        ...
        for mod in bn_loss_list:
            loss_bn += mod.G_kd_loss.sum() * 0.001
